...
if __name__ == "__main__":
    ...
    # target_geometry.apply_sdf(FLAGS.target_mesh, FLAGS)
    ...
    target_triangle_mesh = target_geometry.getMesh(return_triangle=True, thickness_coef=0.3)
    os.makedirs(os.path.join(FLAGS.out_dir, "mesh"), exist_ok=True)
    obj.write_obj(os.path.join(FLAGS.out_dir, "mesh/"), target_triangle_mesh, name="frog_thickness0.3.obj")
